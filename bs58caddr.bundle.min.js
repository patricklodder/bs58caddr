(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.bs58caddr=f()}})(function(){var define,module,exports;return(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){const{Base58AddressValidator}=require('./src/lowlevel')
const validateCoinAddress=require('./src/highlevel')
module.exports={Base58AddressValidator,validateCoinAddress}},{"./src/highlevel":84,"./src/lowlevel":85}],2:[function(require,module,exports){'use strict'
var _Buffer=require('safe-buffer').Buffer
function base(ALPHABET){if(ALPHABET.length>=255){throw new TypeError('Alphabet too long')}
var BASE_MAP=new Uint8Array(256)
for(var j=0;j<BASE_MAP.length;j++){BASE_MAP[j]=255}
for(var i=0;i<ALPHABET.length;i++){var x=ALPHABET.charAt(i)
...
function encode(source){if(Array.isArray(source)||source instanceof Uint8Array){source=_Buffer.from(source)}
...
while(pbegin!==pend){var carry=source[pbegin]
var i=0
for(var it1=size-1;(carry!==0||i<length)&&(it1!==-1);it1--,i++){carry+=(256*b58[it1])>>>0
...
while(source[psz]){var carry=BASE_MAP[source.charCodeAt(psz)]
if(carry===255){return}
var i=0
for(var it3=size-1;(carry!==0||i<length)&&(it3!==-1);it3--,i++){carry+=(BASE*b256[it3])>>>0
...
module.exports=base},{"safe-buffer":58}],3:[function(require,module,exports){'use strict'
...
lookup[(tmp>>4)&0x3F]+
lookup[(tmp<<2)&0x3F]+'=')}
return parts.join('')}},{}],4:[function(require,module,exports){},{}],5:[function(require,module,exports){var basex=require('base-x')
var ALPHABET='123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz'
module.exports=basex(ALPHABET)},{"base-x":2}],6:[function(require,module,exports){'use strict'
...
return payload}
return{encode:encode,decode:decode,decodeUnsafe:decodeUnsafe}}},{"bs58":5,"safe-buffer":58}],7:[function(require,module,exports){'use strict'
var createHash=require('create-hash')
var bs58checkBase=require('./base')
function sha256x2(buffer){var tmp=createHash('sha256').update(buffer).digest()
return createHash('sha256').update(tmp).digest()}
module.exports=bs58checkBase(sha256x2)},{"./base":6,"create-hash":35}],8:[function(require,module,exports){(function(Buffer){(function(){/*!
...
function numberIsNaN(obj){return obj!==obj}}).call(this)}).call(this,require("buffer").Buffer)},{"base64-js":3,"buffer":8,"ieee754":53}],9:[function(require,module,exports){var Buffer=require('safe-buffer').Buffer
...
return out}
module.exports=CipherBase},{"inherits":54,"safe-buffer":58,"stream":67,"string_decoder":82}],10:[function(require,module,exports){var Buffer=require('safe-buffer').Buffer
var coins=[require('./coins/bch'),require('./coins/blk'),require('./coins/btc'),require('./coins/btg'),require('./coins/cbn'),require('./coins/city'),require('./coins/dash'),require('./coins/dnr'),require('./coins/dcr'),require('./coins/dgb'),require('./coins/doge'),require('./coins/grs'),require('./coins/ltc'),require('./coins/via'),require('./coins/mona'),require('./coins/nbt'),require('./coins/nmc'),require('./coins/ppc'),require('./coins/qtum'),require('./coins/rvn'),require('./coins/rdd'),require('./coins/vtc'),require('./coins/x42'),require('./coins/zec')]
var supportedCoins={}
coins.forEach(function(coin){var unit=coin.main.unit.toLowerCase()
...
if(coin.test){coin.test.testnet=true
...
if(coin.regtest){coin.regtest.testnet=true
...
if(coin.simnet){coin.simnet.testnet=true
...
function coininfo(input){var coin=input.toLowerCase()
if(!(coin in supportedCoins)){return null}else{return supportedCoins[coin]}}
coins.forEach(function(coin){coininfo[coin.main.name.toLowerCase()]=coin})
function toBitcoinJS(){return Object.assign({},this,{messagePrefix:this.messagePrefix||('\x19'+this.name+' Signed Message:\n'),bech32:this.bech32,bip32:{public:(this.versions.bip32||{}).public,private:(this.versions.bip32||{}).private},pubKeyHash:this.versions.public,scriptHash:this.versions.scripthash,wif:this.versions.private,dustThreshold:null})}
function toBitcore(){var nm=Buffer.allocUnsafe(4)
nm.writeUInt32BE(this.protocol?this.protocol.magic:0,0)
nm=nm.readUInt32LE(0)
return Object.assign({},this,{name:this.testnet?'testnet':'livenet',alias:this.testnet?'testnet':'mainnet',pubkeyhash:this.versions.public,privatekey:this.versions.private,scripthash:this.versions.scripthash,xpubkey:(this.versions.bip32||{}).public,xprivkey:(this.versions.bip32||{}).private,networkMagic:nm,port:this.port,dnsSeeds:this.seedsDns||[]})}
module.exports=coininfo},{"./coins/bch":11,"./coins/blk":12,"./coins/btc":13,"./coins/btg":14,"./coins/cbn":15,"./coins/city":16,"./coins/dash":17,"./coins/dcr":18,"./coins/dgb":19,"./coins/dnr":20,"./coins/doge":21,"./coins/grs":22,"./coins/ltc":23,"./coins/mona":24,"./coins/nbt":25,"./coins/nmc":26,"./coins/ppc":27,"./coins/qtum":28,"./coins/rdd":29,"./coins/rvn":30,"./coins/via":31,"./coins/vtc":32,"./coins/x42":33,"./coins/zec":34,"safe-buffer":58}],11:[function(require,module,exports){var common={name:'BitcoinCash',per1:1e8,unit:'BCH'}
var main=Object.assign({},{hashGenesisBlock:'000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f',port:8333,portRpc:8332,protocol:{magic:0xe8f3e1e3},seedsDns:['seed.bitcoinabc.org','seed-abc.bitcoinforks.org','btccash-seeder.bitcoinunlimited.info','seed.bitprim.org','seed.deadalnix.me','seeder.criptolayer.net'],versions:{bip32:{private:0x0488ade4,public:0x0488b21e},bip44:145,private:0x80,public:0x00,scripthash:0x05}},common)
var test=Object.assign({},{hashGenesisBlock:'000000000933ea01ad0ee984209779baaec3ced90fa3f408719526f8d77f4943',port:18333,portRpc:18332,protocol:{magic:0xf4f3e5f4},seedsDns:['testnet-seed.bitcoinabc.org','testnet-seed-abc.bitcoinforks.org','testnet-seed.bitprim.org','testnet-seed.deadalnix.me','testnet-seeder.criptolayer.net'],versions:{bip32:{private:0x04358394,public:0x043587cf},bip44:1,private:0xef,public:0x6f,scripthash:0xc4}},common)
var regtest=Object.assign({},{hashGenesisBlock:'0f9188f13cb7b2c71f2a335e3a4fc328bf5beb436012afca590b1a11466e2206',port:18444,portRpc:18332,protocol:{magic:0xfabfb5da},seedsDns:[],versions:{bip32:{private:0x04358394,public:0x043587cf},bip44:1,private:0xef,public:0x6f,scripthash:0xc4}},common)
module.exports={main,test,regtest}},{}],12:[function(require,module,exports){var common={name:'BlackCoin',per1:1e8,unit:'BLK'}
var main=Object.assign({},{hashGenesisBlock:'000001faef25dec4fbcf906e6242621df2c183bf232f263d0ba5b101911e4563',port:15714,portRpc:15715,protocol:{magic:0x05223570},seedsDns:['rat4.blackcoin.co','seed.blackcoin.co','archon.darkfox.id.au','foxy.seeds.darkfox.id.au','6.syllabear.us.to','bcseed.syllabear.us.to'],versions:{bip32:{private:0x0488ade4,public:0x0488b21e},bip44:0xa,private:0x99,public:0x19,scripthash:0x55}},common)
module.exports={main,test:null}},{}],13:[function(require,module,exports){var common={name:'Bitcoin',per1:1e8,unit:'BTC',messagePrefix:'\x18Bitcoin Signed Message:\n'}
var main=Object.assign({},{hashGenesisBlock:'000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f',port:8333,portRpc:8332,protocol:{magic:0xd9b4bef9},bech32:'bc',seedsDns:['seed.bitcoin.sipa.be','dnsseed.bluematt.me','seed.bitcoinstats.com','seed.bitcoin.jonasschnelli.ch','seed.btc.petertodd.org','seed.bitcoin.sprovoost.nl','dnsseed.emzy.de'],versions:{bip32:{private:0x0488ade4,public:0x0488b21e},bip44:0,private:0x80,public:0x00,scripthash:0x05}},common)
...
var regtest=Object.assign({},{hashGenesisBlock:'0f9188f13cb7b2c71f2a335e3a4fc328bf5beb436012afca590b1a11466e2206',port:18444,portRpc:18332,protocol:{magic:0xdab5bffa},bech32:'bcrt',seedsDns:[],versions:{bip32:{private:0x04358394,public:0x043587cf},bip44:1,private:0xef,public:0x6f,scripthash:0xc4}},common)
var simnet=Object.assign({},{hashGenesisBlock:'f67ad7695d9b662a72ff3d8edbbb2de0bfa67b13974bb9910d116d5cbd863e68',port:18555,portRpc:18556,protocol:{magic:0x12141c16},bech32:'sb',seedsDns:[],versions:{bip32:{private:0x0420b900,public:0x0420bd3a},bip44:115,private:0x64,public:0x3f,scripthash:0x7b}},common)
module.exports={main,test,regtest,simnet}},{}],14:[function(require,module,exports){var common={name:'Bitcoin Gold',unit:'BTG'}
var main=Object.assign({},{hashGenesisBlock:'000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f',port:8338,protocol:{magic:0x446d47e1},bech32:'btg',seedsDns:['eu-dnsseed.bitcoingold-official.org','dnsseed.bitcoingold.org','dnsseed.btcgpu.org'],versions:{bip32:{private:0x0488ade4,public:0x0488b21e},bip44:156,private:0x80,public:0x26,scripthash:0x17}},common)
var test=Object.assign({},{hashGenesisBlock:'0x00000000e0781ebe24b91eedc293adfea2f557b53ec379e78959de3853e6f9f6',port:18338,portRpc:18332,protocol:{magic:0x456e48e2},bech32:'tbtg',seedsDns:['test-dnsseed.bitcoingold.org','test-dnsseed.btcgpu.org','eu-test-dnsseed.bitcoingold-official.org'],versions:{bip32:{private:0x04358394,public:0x043587cf},bip44:156,private:0xef,public:0x6f,scripthash:0xc4}},common)
module.exports={main,test}},{}],15:[function(require,module,exports){var common={name:'c0ban',unit:'RYO'}
var main=Object.assign({},{hashGenesisBlock:'000000005184ffce04351e687a3965b300ee011d26b2089232cd039273be4a67',port:3881,portRpc:3882,protocol:{magic:0x6e623063},seedsDns:['jp01.dnsseed.c0ban.com','kr01.dnsseed.c0ban.com'],versions:{bip32:{private:0x0488ade4,public:0x0488b21e},bip44:88888,private:0x88,public:0x12,scripthash:0x1c}},common)
var test=Object.assign({},{hashGenesisBlock:'000000005184ffce04351e687a3965b300ee011d26b2089232cd039273be4a67',port:13881,portRpc:13882,protocol:{magic:0x8e828083},seedsDns:[],versions:{bip32:{private:0x04388388,public:0x04588788},bip44:1,private:0xee,public:0x76,scripthash:0xc6}},common)
var regtest=Object.assign({},{hashGenesisBlock:'3249e44acac8fc67e6b94e882525cea6f5a9853e1ff7b4a1d5f470b23ff8ae11',port:23881,portRpc:23882,protocol:{magic:0xdab5bffa},seedsDns:[],versions:{bip32:{private:0x043587cf,public:0x04358394},bip44:1,private:0xef,public:0x6f,scripthash:0xc4}},common)
module.exports={main,test,regtest}},{}],16:[function(require,module,exports){var common={name:'CityCoin',isProofOfStake:true}
var main=Object.assign({},{unit:'CITY',hashGenesisBlock:'00000b0517068e602ed5279c20168cfa1e69884ee4e784909652da34c361bff2',port:4333,portRpc:4334,protocol:{magic:0x43545901},seedsDns:['seed.city-chain.org','seed.city-coin.org','seed.citychain.foundation','seed.liberstad.com'],versions:{bip32:{private:0x0488ade4,public:0x0488b21e},bip44:1926,private:0xed,public:0x1c,scripthash:0x58}},common)
var test=Object.assign({},{unit:'TCITY',hashGenesisBlock:'00077765f625cc2cb6266544ff7d5a462f25be14ea1116dc2bd2fec17e40a5e3',port:24333,portRpc:24334,protocol:{magic:0x43545401},seedsDns:['testseed.city-chain.org','testseed.city-coin.org','testseed.citychain.foundation'],versions:{bip32:{private:0x0488ade4,public:0x0488b21e},bip44:1926,private:0xc2,public:0x42,scripthash:0xc4}},common)
module.exports={main,test}},{}],17:[function(require,module,exports){var common={name:'Dash',unit:'DASH'}
var main=Object.assign({},{hashGenesisBlock:'00000ffd590b1485b3caadc19b22e6379c733355108f107a430458cdf3407ab6',port:9999,portRpc:9998,protocol:{magic:0xbd6b0cbf},seedsDns:['dash.org','dnsseed.dash.org','dashdot.io','dnsseed.dashdot.io','masternode.io','dnsseed.masternode.io','dashpay.io','dnsseed.dashpay.io'],versions:{bip32:{private:0x0488ade4,public:0x0488b21e},bip44:5,private:0xcc,public:0x4c,scripthash:0x10}},common)
var test=Object.assign({},{hashGenesisBlock:'00000bafbc94add76cb75e2ec92894837288a481e5c005f6563d91623bf8bc2c',port:19999,portRpc:19998,seedsDns:['dashdot.io','testnet-seed.dashdot.io','masternode.io','test.dnsseed.masternode.io'],versions:{bip32:{private:0x04358394,public:0x043587cf},bip44:1,private:0xef,public:0x8c,scripthash:0x13}},common)
module.exports={main,test}},{}],18:[function(require,module,exports){var common={name:'Decred',unit:'DCR'}
...
var test=Object.assign({},{hashGenesisBlock:'5b7466edf6739adc9b32aaedc54e24bdc59a05f0ced855088835fe3cbe58375f',port:19108,portRpc:19109,protocol:{magic:0x48e7a065},seedsDns:['testnet-seed.decred.mindcry.org','testnet-seed.decred.netpurgatory.org','testnet.decredseed.org','testnet-seed.decred.org'],versions:{bip32:{private:0x04358397,public:0x043587d1},bip44:42,private:0x230e,public:0x0f21,scripthash:0x0efc}},common)
module.exports={main,test}},{}],19:[function(require,module,exports){var common={name:'DigiByte',per1:1e8,unit:'DGB'}
var main=Object.assign({},{hashGenesisBlock:'000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f',port:12024,portRpc:14022,protocol:{magic:0xfac3b6da},bech32:'dgb',seedsDns:['seed.digibyte.io','digiexplorer.info','digihash.co'],versions:{bip44:0x80000014,private:0x80,public:0x1e,scripthash:0x3f,scripthash2:0x05}},common)
module.exports={main}},{}],20:[function(require,module,exports){var common={name:'Denarius',unit:'DNR'}
var main=Object.assign({},{hashGenesisBlock:'00000d5dbbda01621cfc16bbc1f9bf3264d641a5dbf0de89fd0182c2c4828fcd',port:33339,portRpc:32339,protocol:{magic:0xb4eff2fa},seedsDns:['denariusexplorer.org','denarius.host','denarius.tech','denarius.network'],versions:{bip32:{private:0x0488ade4,public:0x0488b21e},bip44:116,private:0x9e,public:0x1e,scripthash:0x5a}},common)
var test=Object.assign({},{hashGenesisBlock:'000086bfe8264d241f7f8e5393f747784b8ca2aa98bdd066278d590462a4fdb4',versions:{bip44:1,private:0x8c,public:0x12,scripthash:0x74}},common)
module.exports={main,test}},{}],21:[function(require,module,exports){var common={name:'Dogecoin',unit:'DOGE'}
var main=Object.assign({},{hashGenesisBlock:'1a91e3dace36e2be3bf030a65679fe821aa1d6ef92e7c9902eb318182c355691',port:22556,protocol:{magic:0xc0c0c0c0},seedsDns:['seed.multidoge.org','seed2.multidoge.org'],versions:{bip32:{private:0x02fac398,public:0x02facafd},bip44:3,private:0x9e,public:0x1e,scripthash:0x16}},common)
var test=Object.assign({},{hashGenesisBlock:'bb0a78264637406b6360aad926284d544d7049f45189db5664f3c4d07350559e',port:44556,protocol:{magic:0xfcc1b7dc},seedsDns:['testseed.jrn.me.uk'],versions:{bip32:{private:0x04358394,public:0x043587cf},bip44:1,private:0xf1,public:0x71,scripthash:0xc4}},common)
module.exports={main,test}},{}],22:[function(require,module,exports){var common={name:'Groestlcoin',per1:1e8,unit:'GRS',messagePrefix:'\x1CGroestlCoin Signed Message:\n'}
var main=Object.assign({},{hashGenesisBlock:'00000ac5927c594d49cc0bdb81759d0da8297eb614683d3acb62f0703b639023',port:1331,portRpc:1441,protocol:{magic:0xd4b4bef9},bech32:'grs',seedsDns:['dnsseed1.groestlcoin.org','dnsseed2.groestlcoin.org','dnsseed3.groestlcoin.org','dnsseed4.groestlcoin.org'],versions:{bip32:{private:0x0488ade4,public:0x0488b21e},bip44:17,private:0x80,public:0x24,scripthash:0x05}},common)
var test=Object.assign({},{hashGenesisBlock:'0x000000ffbb50fc9898cdd36ec163e6ba23230164c0052a28876255b7dcf2cd36',port:17777,portRpc:17766,protocol:{magic:0x0709110b},bech32:'tgrs',seedsDns:['testnet-seed1.groestlcoin.org','testnet-seed2.groestlcoin.org'],versions:{bip32:{private:0x04358394,public:0x043587cf},bip44:1,private:0xef,public:0x6f,scripthash:0xc4}},common)
var regtest=Object.assign({},{hashGenesisBlock:'0x000000ffbb50fc9898cdd36ec163e6ba23230164c0052a28876255b7dcf2cd36',port:18888,portRpc:18443,protocol:{magic:0xdab5bffa},bech32:'grsrt',seedsDns:[],versions:{bip32:{private:0x04358394,public:0x043587cf},bip44:1,private:0xef,public:0x6f,scripthash:0xc4}},common)
module.exports={main,test,regtest}},{}],23:[function(require,module,exports){var common={name:'Litecoin',unit:'LTC'}
var main=Object.assign({},{hashGenesisBlock:'12a765e31ffd4059bada1e25190f6e98c99d9714d334efa41a195a7e7e04bfe2',port:9333,protocol:{magic:0xdbb6c0fb},bech32:'ltc',seedsDns:['dnsseed.litecointools.com','dnsseed.litecoinpool.org','dnsseed.ltc.xurious.com','dnsseed.koin-project.com','dnsseed.weminemnc.com'],versions:{bip32:{private:0x019d9cfe,public:0x019da462},bip44:2,private:0xb0,public:0x30,scripthash:0x32,scripthash2:0x05}},common)
var test=Object.assign({},{hashGenesisBlock:'f5ae71e26c74beacc88382716aced69cddf3dffff24f384e1808905e0188f68f',bech32:'tltc',versions:{bip32:{private:0x0436ef7d,public:0x0436f6e1},bip44:1,private:0xef,public:0x6f,scripthash:0x3a,scripthash2:0xc4}},common)
module.exports={main,test}},{}],24:[function(require,module,exports){var common={name:'Monacoin',unit:'MONA'}
var main=Object.assign({},{hashGenesisBlock:'ff9f1c0116d19de7c9963845e129f9ed1bfc0b376eb54fd7afa42e0d418c8bb6',port:9401,portRpc:9402,protocol:{magic:0xdbb6c0fb},bech32:'mona',seedsDns:['dnsseed.monacoin.org'],versions:{bip32:{private:0x0488ade4,public:0x0488b21e},bip44:22,private:0xb0,private2:0xb2,public:0x32,scripthash:0x37,scripthash2:0x05}},common)
var test=Object.assign({},{hashGenesisBlock:'a2b106ceba3be0c6d097b2a6a6aacf9d638ba8258ae478158f449c321061e0b2',port:19403,portRpc:19402,protocol:{magic:0xf1c8d2fd},bech32:'tmona',seedsDns:['testnet-dnsseed.monacoin.org'],versions:{bip32:{private:0x04358394,public:0x043587cf},bip44:1,private:0xef,public:0x6f,scripthash:0x75,scripthash2:0xc4}},common)
module.exports={main,test}},{}],25:[function(require,module,exports){var common={name:'NuBits',per1:1e6,unit:'NBT'}
var main=Object.assign({},{hashGenesisBlock:'000003cc2da5a0a289ad0a590c20a8b975219ddc1204efd169e947dd4cbad73f',port:7890,portRpc:14002,protocol:{magic:0xd9b4bef9},seedsDns:[],versions:{bip32:{private:0x0488ade4,public:0x0488b21e},bip44:12,private:0x96,public:0x19,scripthash:0x1a}},common)
module.exports={main}},{}],26:[function(require,module,exports){var common={name:'Namecoin',unit:'NMC'}
var main=Object.assign({},{hashGenesisBlock:'000000000062b72c5e2ceb45fbc8587e807c155b0da735e6483dfba2f0a9c770',versions:{bip44:7,private:0xb4,public:0x34,scripthash:0x05}},common)
module.exports={main,test:null}},{}],27:[function(require,module,exports){var common={name:'Peercoin',per1:1e6,unit:'PPC',messagePrefix:'\x18Peercoin Signed Message:\n'}
var main=Object.assign({},{hashGenesisBlock:'0000000032fe677166d54963b62a4677d8957e87c508eaa4fd7eb1c880cd27e3',port:9901,portRpc:9902,protocol:{magic:0xe5e9e8e6},seedsDns:['seed.peercoin.net','seed2.peercoin.net','seed.peercoin-library.org','ppcseed.ns.7server.net'],versions:{bip32:{private:0x0488ade4,public:0x0488b21e},bip44:6,private:0xb7,public:0x37,scripthash:0x75}},common)
...
module.exports={main,test}},{}],28:[function(require,module,exports){var common={name:'Qtum',unit:'QTUM'}
var main=Object.assign({},{hashGenesisBlock:'000075aef83cf2853580f8ae8ce6f8c3096cfa21d98334d6e3f95e5582ed986c',port:3888,protocol:{magic:0xd3a6cff1},bech32:'qc',seedsDns:['qtum3.dynu.net'],versions:{bip32:{private:0x0488ade4,public:0x0488b21e},bip44:2301,private:0x80,public:0x3A,scripthash:0x32}},common)
module.exports={main}},{}],29:[function(require,module,exports){var common={name:'ReddCoin',unit:'RDD'}
var main=Object.assign({},{hashGenesisBlock:'b868e0d95a3c3c0e0dadc67ee587aaf9dc8acbf99e3b4b3110fad4eb74c1decc',versions:{bip44:4,private:0xbd,public:0x3d,scripthash:0x05}},common)
var test=Object.assign({},{hashGenesisBlock:'a12ac9bd4cd26262c53a6277aafc61fe9dfe1e2b05eaa1ca148a5be8b394e35a',versions:{bip44:1,private:0xef,public:0x6f,scripthash:0xc4}},common)
module.exports={main,test}},{}],30:[function(require,module,exports){var common={name:'Ravencoin',unit:'RVN'}
var main=Object.assign({},{hashGenesisBlock:'0000006b444bc2f2ffe627be9d9e7e7a0730000870ef6eb6da46c8eae389df90',port:8767,protocol:{magic:0x4e564152},bech32:'rc',seedsDns:['seed-raven.bitactivate.com','seed-raven.ravencoin.com','seed-raven.ravencoin.org'],versions:{bip32:{private:0x0488ade4,public:0x0488b21e},bip44:175,private:0x80,public:0x3c,scripthash:0x7a}},common)
...
module.exports={main,test}},{}],31:[function(require,module,exports){var common={name:'Viacoin',unit:'VIA'}
...
var test=Object.assign({},{hashGenesisBlock:'770aa712aa08fdcbdecc1c8df1b3e2d4e17a7cf6e63a28b785b32e74c96cb27d',port:25223,protocol:{magic:0x92efc5a9},seedsDns:['testnet.viacoin.net','seed-testnet.viacoin.net'],versions:{bip32:{private:0x04358394,public:0x043587cf},bip44:1,private:0xff,public:0x7f,scripthash:0xc4}},common)
module.exports={main,test}},{}],32:[function(require,module,exports){var common={name:'Vertcoin',unit:'VTC'}
var main=Object.assign({},{hashGenesisBlock:'4d96a915f49d40b1e5c2844d1ee2dccb90013a990ccea12c492d22110489f0c4',port:5889,protocol:{magic:0xdab5bffa},bech32:'vtc',seedsDns:['useast1.vtconline.org','vtc.gertjaap.org','seed.vtc.bryangoodson.org','dnsseed.pknight.ca','seed.orderofthetaco.org','seed.alexturek.org','vertcoin.mbl.cash'],versions:{bip32:{private:0x0488ade4,public:0x0488b21e},bip44:28,private:0x80,public:0x47,scripthash:0x05}},common)
var test=Object.assign({},{hashGenesisBlock:'cee8f24feb7a64c8f07916976aa4855decac79b6741a8ec2e32e2747497ad2c9',port:15889,protocol:{magic:0x74726576},bech32:'tvtc',seedsDns:['jlovejoy.mit.edu','gertjaap.ddns.net','fr1.vtconline.org','tvtc.vertcoin.org'],versions:{bip32:{private:0x04358394,public:0x043587cf},private:0xef,public:0x4a,scripthash:0xc4}},common)
var regtest=Object.assign({},{hashGenesisBlock:'0f9188f13cb7b2c71f2a335e3a4fc328bf5beb436012afca590b1a11466e2206',port:18444,protocol:{magic:0xdab5bffa},seedsDns:[],versions:{bip32:{private:0x04358394,public:0x043587cf},private:0xef,public:0x6f,scripthash:0xc4}},common)
module.exports={main,test,regtest}},{}],33:[function(require,module,exports){var common={name:'x42',isProofOfStake:true}
var main=Object.assign({},{unit:'x42',hashGenesisBlock:'04ffe583707a96c1c2eb54af33a4b1dc6d9d8e09fea8c9a7b097ba88f0cb64c4',port:52342,portRpc:52343,protocol:{magic:0x3526642},seedsDns:['mainnet1.x42seed.host','mainnetnode1.x42seed.host','tech.x42.cloud','x42.seed.blockcore.net'],versions:{bip32:{private:0x0488ade4,public:0x0488b21e},bip44:424242,private:0xcb,public:0x4b,scripthash:0x7d}},common)
var test=Object.assign({},{unit:'Tx42',hashGenesisBlock:'a92bf124a1e6f237015440d5f1e1999bdef8e321f2d3fdc367eb2f7733b17854',port:62342,portRpc:62343,protocol:{magic:0x4526642},seedsDns:['testnet1.x42seed.host'],versions:{bip32:{private:0x0488ade4,public:0x0488b21e},bip44:424242,private:0xc1,public:0x41,scripthash:0xc4}},common)
module.exports={main,test}},{}],34:[function(require,module,exports){var common={name:'Zcash',unit:'ZEC'}
var main=Object.assign({},{hashGenesisBlock:'00040fe8ec8471911baa1db1266ea15dd06b4a8a5c453883c000b031973dce08',port:8233,portRpc:8232,protocol:{magic:0x6427e924},seedsDns:['dnsseed.z.cash','dnsseed.str4d.xyz','dnsseed.znodes.org'],versions:{bip32:{private:0x0488ade4,public:0x0488b21e},bip44:133,private:0x80,public:0x1cb8,scripthash:0x1cbd}},common)
var test=Object.assign({},{hashGenesisBlock:'0x05a60a92d99d85997cce3b87616c089f6124d7342af37106edc76126334a2c38',port:18233,portRpc:18232,protocol:{magic:0xbff91afa},seedsDns:['dnsseed.testnet.z.cash'],versions:{bip32:{private:0x04358394,public:0x043587cf},bip44:133,private:0xef,public:0x1d25,scripthash:0x1cba}},common)
module.exports={main,test}},{}],35:[function(require,module,exports){'use strict'
var inherits=require('inherits')
...
return new Hash(sha(alg))}},{"cipher-base":9,"inherits":54,"md5.js":55,"ripemd160":57,"sha.js":60}],36:[function(require,module,exports){'use strict';var R=typeof Reflect==='object'?Reflect:null
...
listener(arg);});}else{throw new TypeError('The "emitter" argument must be of type EventEmitter. Received type '+typeof emitter);}}},{}],37:[function(require,module,exports){'use strict'
var Buffer=require('safe-buffer').Buffer
...
module.exports=HashBase},{"inherits":54,"readable-stream":52,"safe-buffer":58}],38:[function(require,module,exports){'use strict';function _inheritsLoose(subClass,superClass){subClass.prototype=Object.create(superClass.prototype);subClass.prototype.constructor=subClass;subClass.__proto__=superClass;}
...
if(!dest){var dests=state.pipes;var len=state.pipesCount;state.pipes=null;state.pipesCount=0;state.flowing=false;for(var i=0;i<len;i++)dests[i].emit('unpipe',this,{hasUnpiped:false});return this;}
...
this._writableState.destroyed=value;}});Writable.prototype.destroy=destroyImpl.destroy;Writable.prototype._undestroy=destroyImpl.undestroy;Writable.prototype._destroy=function(err,cb){cb(err);};}).call(this)}).call(this,require('_process'),typeof global!=="undefined"?global:typeof self!=="undefined"?self:typeof window!=="undefined"?window:{})},{"../errors":38,"./_stream_duplex":39,"./internal/streams/destroy":46,"./internal/streams/state":50,"./internal/streams/stream":51,"_process":56,"buffer":8,"inherits":54,"util-deprecate":83}],44:[function(require,module,exports){(function(process){(function(){'use strict';var _Object$setPrototypeO;function _defineProperty(obj,key,value){key=_toPropertyKey(key);if(key in obj){Object.defineProperty(obj,key,{value:value,enumerable:true,configurable:true,writable:true});}else{obj[key]=value;}return obj;}
...
iterator[kEnded]=true;});stream.on('readable',onReadable.bind(null,iterator));return iterator;};module.exports=createReadableStreamAsyncIterator;}).call(this)}).call(this,require('_process'))},{"./end-of-stream":47,"_process":56}],45:[function(require,module,exports){'use strict';function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);enumerableOnly&&(symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;})),keys.push.apply(keys,symbols);}return keys;}
...
_createClass(BufferList,[{key:"push",value:function push(v){var entry={data:v,next:null};if(this.length>0)this.tail.next=entry;else this.head=entry;this.tail=entry;++this.length;}},{key:"unshift",value:function unshift(v){var entry={data:v,next:this.head};if(this.length===0)this.tail=entry;this.head=entry;++this.length;}},{key:"shift",value:function shift(){if(this.length===0)return;var ret=this.head.data;if(this.length===1)this.head=this.tail=null;else this.head=this.head.next;--this.length;return ret;}},{key:"clear",value:function clear(){this.head=this.tail=null;this.length=0;}},{key:"join",value:function join(s){if(this.length===0)return'';var p=this.head;var ret=''+p.data;while(p=p.next)ret+=s+p.data;return ret;}},{key:"concat",value:function concat(n){if(this.length===0)return Buffer.alloc(0);var ret=Buffer.allocUnsafe(n>>>0);var p=this.head;var i=0;while(p){copyBuffer(p.data,ret,i);i+=p.data.length;p=p.next;}
...
module.exports=pipeline;},{"../../../errors":38,"./end-of-stream":47}],50:[function(require,module,exports){'use strict';var ERR_INVALID_OPT_VALUE=require('../../../errors').codes.ERR_INVALID_OPT_VALUE;function highWaterMarkFrom(options,isDuplex,duplexKey){return options.highWaterMark!=null?options.highWaterMark:isDuplex?options[duplexKey]:null;}
...
module.exports={getHighWaterMark:getHighWaterMark};},{"../../../errors":38}],51:[function(require,module,exports){module.exports=require('events').EventEmitter;},{"events":36}],52:[function(require,module,exports){exports=module.exports=require('./lib/_stream_readable.js');exports.Stream=exports;exports.Readable=exports;exports.Writable=require('./lib/_stream_writable.js');exports.Duplex=require('./lib/_stream_duplex.js');exports.Transform=require('./lib/_stream_transform.js');exports.PassThrough=require('./lib/_stream_passthrough.js');exports.finished=require('./lib/internal/streams/end-of-stream.js');exports.pipeline=require('./lib/internal/streams/pipeline.js');},{"./lib/_stream_duplex.js":39,"./lib/_stream_passthrough.js":40,"./lib/_stream_readable.js":41,"./lib/_stream_transform.js":42,"./lib/_stream_writable.js":43,"./lib/internal/streams/end-of-stream.js":47,"./lib/internal/streams/pipeline.js":49}],53:[function(require,module,exports){/*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> */exports.read=function(buffer,offset,isLE,mLen,nBytes){var e,m
...
buffer[offset+i-d]|=s*128}},{}],54:[function(require,module,exports){if(typeof Object.create==='function'){module.exports=function inherits(ctor,superCtor){if(superCtor){ctor.super_=superCtor
...
ctor.prototype.constructor=ctor}}}},{}],55:[function(require,module,exports){'use strict'
var inherits=require('inherits')
...
module.exports=MD5},{"hash-base":37,"inherits":54,"safe-buffer":58}],56:[function(require,module,exports){var process=module.exports={};var cachedSetTimeout;var cachedClearTimeout;function defaultSetTimout(){throw new Error('setTimeout has not been defined');}
...
process.binding=function(name){throw new Error('process.binding is not supported');};process.cwd=function(){return'/'};process.chdir=function(dir){throw new Error('process.chdir is not supported');};process.umask=function(){return 0;};},{}],57:[function(require,module,exports){'use strict'
...
module.exports=RIPEMD160},{"buffer":8,"hash-base":37,"inherits":54}],58:[function(require,module,exports){/*! safe-buffer. MIT License. Feross Aboukhadijeh <https://feross.org/opensource> */var buffer=require('buffer')
...
return buffer.SlowBuffer(size)}},{"buffer":8}],59:[function(require,module,exports){var Buffer=require('safe-buffer').Buffer
...
module.exports=Hash},{"safe-buffer":58}],60:[function(require,module,exports){var exports=module.exports=function SHA(algorithm){algorithm=algorithm.toLowerCase()
...
exports.sha512=require('./sha512')},{"./sha":61,"./sha1":62,"./sha224":63,"./sha256":64,"./sha384":65,"./sha512":66}],61:[function(require,module,exports){var inherits=require('inherits')
...
return H}
module.exports=Sha},{"./hash":59,"inherits":54,"safe-buffer":58}],62:[function(require,module,exports){var inherits=require('inherits')
var Hash=require('./hash')
var Buffer=require('safe-buffer').Buffer
var K=[0x5a827999,0x6ed9eba1,0x8f1bbcdc|0,0xca62c1d6|0]
var W=new Array(80)
...
H.writeInt32BE(this._e|0,16)
return H}
module.exports=Sha1},{"./hash":59,"inherits":54,"safe-buffer":58}],63:[function(require,module,exports){var inherits=require('inherits')
...
return H}
module.exports=Sha224},{"./hash":59,"./sha256":64,"inherits":54,"safe-buffer":58}],64:[function(require,module,exports){var inherits=require('inherits')
var Hash=require('./hash')
var Buffer=require('safe-buffer').Buffer
...
return H}
module.exports=Sha256},{"./hash":59,"inherits":54,"safe-buffer":58}],65:[function(require,module,exports){var inherits=require('inherits')
...
return H}
module.exports=Sha384},{"./hash":59,"./sha512":66,"inherits":54,"safe-buffer":58}],66:[function(require,module,exports){var inherits=require('inherits')
var Hash=require('./hash')
var Buffer=require('safe-buffer').Buffer
...
return H}
module.exports=Sha512},{"./hash":59,"inherits":54,"safe-buffer":58}],67:[function(require,module,exports){module.exports=Stream;var EE=require('events').EventEmitter;var inherits=require('inherits');inherits(Stream,EE);Stream.Readable=require('readable-stream/lib/_stream_readable.js');Stream.Writable=require('readable-stream/lib/_stream_writable.js');Stream.Duplex=require('readable-stream/lib/_stream_duplex.js');Stream.Transform=require('readable-stream/lib/_stream_transform.js');Stream.PassThrough=require('readable-stream/lib/_stream_passthrough.js');Stream.finished=require('readable-stream/lib/internal/streams/end-of-stream.js')
Stream.pipeline=require('readable-stream/lib/internal/streams/pipeline.js')
Stream.Stream=Stream;function Stream(){EE.call(this);}
...
source.on('end',cleanup);source.on('close',cleanup);dest.on('close',cleanup);dest.emit('pipe',source);return dest;};},{"events":36,"inherits":54,"readable-stream/lib/_stream_duplex.js":69,"readable-stream/lib/_stream_passthrough.js":70,"readable-stream/lib/_stream_readable.js":71,"readable-stream/lib/_stream_transform.js":72,"readable-stream/lib/_stream_writable.js":73,"readable-stream/lib/internal/streams/end-of-stream.js":77,"readable-stream/lib/internal/streams/pipeline.js":79}],68:[function(require,module,exports){arguments[4][38][0].apply(exports,arguments)},{"dup":38}],69:[function(require,module,exports){arguments[4][39][0].apply(exports,arguments)},{"./_stream_readable":71,"./_stream_writable":73,"_process":56,"dup":39,"inherits":54}],70:[function(require,module,exports){arguments[4][40][0].apply(exports,arguments)},{"./_stream_transform":72,"dup":40,"inherits":54}],71:[function(require,module,exports){arguments[4][41][0].apply(exports,arguments)},{"../errors":68,"./_stream_duplex":69,"./internal/streams/async_iterator":74,"./internal/streams/buffer_list":75,"./internal/streams/destroy":76,"./internal/streams/from":78,"./internal/streams/state":80,"./internal/streams/stream":81,"_process":56,"buffer":8,"dup":41,"events":36,"inherits":54,"string_decoder/":82,"util":4}],72:[function(require,module,exports){arguments[4][42][0].apply(exports,arguments)},{"../errors":68,"./_stream_duplex":69,"dup":42,"inherits":54}],73:[function(require,module,exports){arguments[4][43][0].apply(exports,arguments)},{"../errors":68,"./_stream_duplex":69,"./internal/streams/destroy":76,"./internal/streams/state":80,"./internal/streams/stream":81,"_process":56,"buffer":8,"dup":43,"inherits":54,"util-deprecate":83}],74:[function(require,module,exports){arguments[4][44][0].apply(exports,arguments)},{"./end-of-stream":77,"_process":56,"dup":44}],75:[function(require,module,exports){arguments[4][45][0].apply(exports,arguments)},{"buffer":8,"dup":45,"util":4}],76:[function(require,module,exports){arguments[4][46][0].apply(exports,arguments)},{"_process":56,"dup":46}],77:[function(require,module,exports){arguments[4][47][0].apply(exports,arguments)},{"../../../errors":68,"dup":47}],78:[function(require,module,exports){arguments[4][48][0].apply(exports,arguments)},{"dup":48}],79:[function(require,module,exports){arguments[4][49][0].apply(exports,arguments)},{"../../../errors":68,"./end-of-stream":77,"dup":49}],80:[function(require,module,exports){arguments[4][50][0].apply(exports,arguments)},{"../../../errors":68,"dup":50}],81:[function(require,module,exports){arguments[4][51][0].apply(exports,arguments)},{"dup":51,"events":36}],82:[function(require,module,exports){'use strict';var Buffer=require('safe-buffer').Buffer;var isEncoding=Buffer.isEncoding||function(encoding){encoding=''+encoding;switch(encoding&&encoding.toLowerCase()){case'hex':case'utf8':case'utf-8':case'ascii':case'binary':case'base64':case'ucs2':case'ucs-2':case'utf16le':case'utf-16le':case'raw':return true;default:return false;}};function _normalizeEncoding(enc){if(!enc)return'utf8';var retried;while(true){switch(enc){case'utf8':case'utf-8':return'utf8';case'ucs2':case'ucs-2':case'utf16le':case'utf-16le':return'utf16le';case'latin1':case'binary':return'latin1';case'base64':case'ascii':case'hex':return enc;default:if(retried)return;enc=(''+enc).toLowerCase();retried=true;}}};function normalizeEncoding(enc){var nenc=_normalizeEncoding(enc);if(typeof nenc!=='string'&&(Buffer.isEncoding===isEncoding||!isEncoding(enc)))throw new Error('Unknown encoding: '+enc);return nenc||enc;}
...
function simpleEnd(buf){return buf&&buf.length?this.write(buf):'';}},{"safe-buffer":58}],83:[function(require,module,exports){(function(global){(function(){module.exports=deprecate;function deprecate(fn,msg){if(config('noDeprecation')){return fn;}
...
var val=global.localStorage[name];if(null==val)return false;return String(val).toLowerCase()==='true';}}).call(this)}).call(this,typeof global!=="undefined"?global:typeof self!=="undefined"?self:typeof window!=="undefined"?window:{})},{}],84:[function(require,module,exports){const{Base58AddressValidator}=require('./lowlevel')
const coininfo=require('coininfo')
function validateCoinAddress(coin,address){if(typeof coin!=='string'){return false}
const info=coininfo(coin.toUpperCase())
if(info===null){return false}
const validator=new Base58AddressValidator()
try{validator.networkBytes([info.versions.public,info.versions.scripthash]).address(address).validate()
return true}catch(err){}
return false}
module.exports=validateCoinAddress},{"./lowlevel":85,"coininfo":10}],85:[function(require,module,exports){const bs58check=require('bs58check')
class Base58AddressValidator{constructor(){this.m_address=''
this.m_networkBytes=''}
address(addr){const argtype=typeof addr
if(argtype!=='string'){throw new Error('Expected string argument, got '+argtype)}
this.m_address=addr
return this}
addNetworkByte(networkByte){const argtype=typeof networkByte
if(argtype!=='number'){throw new Error('Expected numerical argument, got '+argtype)}
if(networkByte>0xff||networkByte<0){throw new Error('Maximum network byte size is '+0xff)}
this.m_networkBytes.push(networkByte)
return this}
networkBytes(arr){if(!Array.isArray(arr)){throw new Error('Expected array argument, got '+(typeof arr))}
this.m_networkBytes=[]
arr.forEach(nwb=>this.addNetworkByte(nwb))
return this}
validate(){if(this.m_address===''){throw new Error('No address specified')}
const buffer=bs58check.decode(this.m_address)
if(this.m_networkBytes.length>0){const networkByte=buffer.readUInt8(0)
if(this.m_networkBytes.indexOf(networkByte)===-1){throw new Error('Unexpected network byte: '+networkByte)}}}}
module.exports={Base58AddressValidator}},{"bs58check":7}]},{},[1])(1)});